      ...
      <div>
        <div className={s.contenidoAcercaDe}>
          <div className={s.izquierdo}>
            ...
            <p>
              Dejar un <span> mejor planeta</span> a nuestros hijos y{" "}
              <span>mejores hijos</span> a nuestro planeta
            </p>
            <p>
              Dedicamos tiempo y trabajo en desarrollar e implementar{" "}
              <span> proyectos innovadores </span>que reestablezcan el
              equilibrio de <span> ecosistemas </span>amenazados y{" "}
              ...
              >
                <ul>
                  <li>
                    ...
                    <div>
                      <span>Restaurar Ecosistemas:</span> Trabajar en proyectos
                      que revitalicen la biodiversidad.
                    </div>
                  </li>
                  <li>
                    ...
                    <div>
                      <span>Apoyar Comunidades: </span>Colaborar para mejorar la
                      calidad de vida en áreas vulnerables.
                    </div>
                  </li>
                  <li>
                    ...
                    <div>
                      ...
                      Crear conciencia y educar sobre la importancia del cuidado
                      del medio ambiente.
                    </div>
                  </li>
                  <li>
                    ...
                    <div>
                      ...
                      Implementar prácticas sostenibles para minimizar el
                      impacto ambiental.
                    </div>
                  </li>
                </ul>
              ...
              >
                <ul>
                  ...
                  <li>
                    ...
                    <div>
                      <span>Empoderamiento: </span>Comunidades vulnerables con
